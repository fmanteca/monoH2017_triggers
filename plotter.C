...
void plotter(Int_t Nsame, TString variable, TString channel, TString sample1, TString sample2, TString sample3, TString sample4, TString sample5, TString Type) { 
  ...
  if(Nsame == 2){
    ...
    TFile* file5 = new TFile("output_nanoLatino_monoH_" + sample5 + ".root");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_ee_latino");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_em_latino");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_mm_latino");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_inc_latino");
      }
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_ee_new");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_em_new");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_mm_new");
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_drll_inc_new");
      }
    }else if(variable == "pt1"){
      if(channel == "ee" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_ee_latino");
      }else if(channel == "em" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_em_latino");
      }else if(channel=="mm" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_mm_latino");
      }else if(channel=="inc" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_inc_latino");
      }
      if(channel == "ee" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_ee_new");
      }else if(channel == "em" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_em_new");
      }else if(channel=="mm" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_mm_new");
      }else if(channel=="inc" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt1_inc_new");
      }
    }else if(variable == "pt2"){
      if(channel == "ee" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_ee_latino");
      }else if(channel == "em" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_em_latino");
      }else if(channel=="mm" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_mm_latino");
      }else if(channel=="inc" && Type == "latino"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_inc_latino");
      }
      if(channel == "ee" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_ee_new");
      }else if(channel == "em" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_em_new");
      }else if(channel=="mm" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_mm_new");
      }else if(channel=="inc" && Type == "new"){
	...
	TH1F* h_5 = (TH1F*)file5->Get("h_pt2_inc_new");
      }
    }
    ...
    legend1->AddEntry(h_5, sample5,"l");
    legend1->Draw();
